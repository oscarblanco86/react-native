...
import { ImageSourcePropType, Image, useWindowDimensions, NativeScrollEvent, NativeSyntheticEvent } from 'react-native';
...
const SlidesScreen = () => {
  ...
  const onScroll = (event: NativeSyntheticEvent<NativeScrollEvent>) => {
    ...
    if ( currentIndex === items.length -1) setisScrollEnabled(true)
  }
